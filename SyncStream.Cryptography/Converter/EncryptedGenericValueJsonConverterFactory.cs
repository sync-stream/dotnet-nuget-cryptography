...
/// </summary>
public class EncryptedGenericValueJsonConverterFactory : JsonConverterFactory
{
    /// <summary>
    ...
    public override bool CanConvert(Type typeToConvert)
    {
        ...
        return typeToConvert.GetGenericTypeDefinition() == typeof(EncryptedValueWithIndex<>);
    }
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options) =>
        (JsonConverter) Activator.CreateInstance(
            type: typeof(EncryptedValue<>).MakeGenericType(new Type[] {typeToConvert.GetGenericArguments()[0]}),
            BindingFlags.Instance | BindingFlags.Public, binder: null, args: new object[] {options}, culture: null)!;
}
