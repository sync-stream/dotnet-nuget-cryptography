...
/// <summary>
/// This class maintains our JSON converter for serializing and deserializing encrypted values with indexes 
/// </summary>
public class EncryptedValueWithIndexJsonConverter : JsonConverter<EncryptedValueWithIndex>
{
    /// <summary>
    ...
    public override EncryptedValueWithIndex Read(ref Utf8JsonReader reader, Type typeToConvert,
    ...
    /// <param name="options">The JSON serializer options</param>
    public override void Write(Utf8JsonWriter writer, EncryptedValueWithIndex value, JsonSerializerOptions options) =>
