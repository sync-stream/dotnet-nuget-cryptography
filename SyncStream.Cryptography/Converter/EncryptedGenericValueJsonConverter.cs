...
/// </summary>
public class EncryptedGenericValueJsonConverter<TSource> : JsonConverter<EncryptedValue<TSource>> where TSource: class, new()
{
    /// <summary>
    ...
    public override EncryptedValue<TSource> Read(ref Utf8JsonReader reader, Type typeToConvert,
    ...
    public override void
        Write(Utf8JsonWriter writer, EncryptedValue<TSource> value, JsonSerializerOptions options) =>
